...
RSpec.describe SignalCatcher::Indicators::BBandsPercent do
  ...
  describe 'indicator results' do
    ...
    let(:key) { 'b_bands_percent_ohlcv_value_close_time_period_20' }
    ...
    context 'with USDT_BTC pair' do
      ...
      let(:indicator_tv_results) { Oj.load_file('spec/fixtures/usdt_btc_1d/b_bands_percent.json') }
    ...
    context 'with USDT_PIT pair' do
      ...
      let(:indicator_tv_results) { Oj.load_file('spec/fixtures/usdt_pit_1d/b_bands_percent.json') }
